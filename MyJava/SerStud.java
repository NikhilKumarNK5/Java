...
public class SerStud 
{
    public static void main(String[] args) throws Exception 
	{
        //Serialization of Student Object
        Student s1 = new Student(1,"Rahul","+917943562185");
        Student s2 = new Student(2,"Ankita","+916903742892");
        Student s3 = new Student(3,"Sameer","+919423931329");
